...
export const BarcodeScanner = ({ onScan, onNext, verificationId }) => {
  const {
    videoRef,
    isStreaming,
    isLoading,
  ...
  return (
    <div className="page-layout">
      ...
      <div className="page-content">
        <div className="content-card">
          <div className="card-header barcode-header">
            <Scan className="icon" />
            <h1>Scan Barcode</h1>
          ...
          <div className="card-body">
            ...
            {ocrStatus === 'SUCCESSFUL' && (
              <div className="alert alert-success">
                <strong>Barcode Status: SUCCESSFUL</strong>
              </div>
            )}
