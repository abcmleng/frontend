...
export const KYCFlow = ({ userId }) => {
  ...
  const handleSelfieCapture = (image) => {
    setKycData((prev) => ({
      ...prev,
      selfie: image,
      processingStatus: {
  ...
  const handleDocumentFrontCapture = (image) => {
    setKycData((prev) => ({
      ...prev,
      documentFront: image,
      processingStatus: {
  ...
  const handleDocumentBackCapture = (image) => {
    setKycData((prev) => ({
      ...prev,
      documentBack: image,
      processingStatus: {
  ...
  const handleMRZScan = async (mrzData) => {
    setKycData((prev) => ({
      ...prev,
      mrzData,
      processingStatus: {
